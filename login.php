...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in to Skyscrip</h2>
          <p>
            <a href="register-page.php">Sign up Now!</a> for a skyscrip account,It's free and always will be..</p>
          <br>
        </div>
